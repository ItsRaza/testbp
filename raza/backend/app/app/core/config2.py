...
EMAIL_CONFIRMATION_TOKEN_EXPIRE_HOURS = env.int(
    "EMAIL_CONFIRMATION_TOKEN_EXPIRE_HOURS", default=24)
...
USERS_PASSWORDLESS_REGISTRATION = env.bool(
    "USERS_PASSWORDLESS_REGISTRATION", default=True)
...
FRONTEND_RESET_PASSWORD_URL = env.str(
    'FRONTEND_RESET_PASSWORD_URL', default='/reset/{token}')
